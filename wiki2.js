...
function addtosuggestionsanswers(result1, labelsUL, entityID) {
    ...
    var $insertElem = $('<tr><td> ' +
            ...
            result1.property + '</a></td><td>' + result1.question + '</td><td>' + result1.wikidataLink + ' '+ 
...
( function( mw, $ ) {
	...
	function init() 
	{
        ...
        $.getJSON( 'https://tools.wmflabs.org/recoin/getmissingattributes.php?callback=?', 'subject=' + entityID + '&lang=' + lang + '&n=20',
			   function ( result ) 
			   {
		...
		var tablehead1 = '<thead align="left"><tr bgcolor="#DCDCDC"><td>Property ID</td><td>Answer</td><td>Relative</td><td>Add Claim</td></tr></thead>';
		labelsUL1.append(tablehead);
